...
public class AlchemyTableMenu extends AbstractContainerMenu {
    ...
    public AlchemyTableMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ALCHEMY_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 62, 23));
    ...
    public int getScaledEnergy() {
        ...
        return maxEnergy != 0 && energy != 0 ? energy * progressBarSize / maxEnergy : 0;
    }
    ...
    public boolean stillValid(Player p_38874_) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                p_38874_, ModBlocks.ALCHEMY_TABLE.get());
    }
