...
public class CullagerRenderer<T extends SpellcasterIllager> extends IllagerRenderer<T> {
    private static final ResourceLocation CULLAGER_ILLAGER = new ResourceLocation("bitsandbaubs:textures/entity/cullager.png");

    public CullagerRenderer(EntityRendererProvider.Context p_174108_) {
